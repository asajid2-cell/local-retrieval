...
| --- | --- | --- | --- |
| L1 muxd launch coordinator | one create/relaunch owner; old PID exited | muxd unit + local integration race tests | running |
| L2 shared launch identity | C# and muxd contend on the same alias claim files | cross-language claim compatibility tests | pending |
